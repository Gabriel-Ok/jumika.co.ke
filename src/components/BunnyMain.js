...
function searchFor(term) {
 ...
 class BunnyMain extends React.Component {
...
{/* =========================================================================================================================================== */}
    ...
    {/* ==============mapItems============================ */}
        {this.state.items.filter(searchFor(this.state.term)).map((getItems, index)=>{
...
{/* =========================================================================================================================================== */}
      ...
      {/* ==============row for children item============================ */}

      <div className="row">

{/* ==============mapItems============================ */}
 {this.state.Childrenitems.filter(searchFor(this.state.term)).map((getItems, index)=>{
         return (
